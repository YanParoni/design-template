...
const SignIn = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    const authInterval = setInterval(() => {
      if (authWindow?.closed) {
        ...
        // Checar se o token foi armazenado localmente após o redirecionamento
  ...
  return (
    <div className="flex h-full w-full items-center justify-center sm:pt-12">
      <div className="relative flex h-full w-full flex-col justify-center bg-[#5a4466] pb-20 pt-12 sm:h-[432px] sm:w-[495px] sm:max-w-[38.15rem] sm:rounded-lg">
        <div className="">
        ...
        <button
          ...
          className={`absolute bottom-0 h-14 w-full rounded-b-lg bg-[#5a4466] px-1 py-2 text-[11px] font-bold text-comp-description shadow-light transition duration-200 hover:text-accent-theme sm:px-24`}
        >
