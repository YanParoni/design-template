...
const Input: React.FC<InputProps> = ({ label, variant, type = 'text', onChange, forgottenLabel }) => {
  ...
  const primaryStyles = 'bg-light-purple text-description border-b-[2px] border-[#574766]';
  const secondaryStyles = 'bg-[#d7c2ea] text-description border-b-[2px] border-[#574766]';
