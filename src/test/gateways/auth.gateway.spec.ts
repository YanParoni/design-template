...
describe('AuthGateway', () => {
  ...
  it('should fetch user profile', async () => {
    fetchHttpClientMock.get.mockResolvedValue({ data: { id: 'user-id' }, error: null });
  ...
  it('should login a user', async () => {
    ...
    fetchHttpClientMock.post.mockResolvedValue({ data: { token: 'token' }, error: null });
  ...
  it('should request password reset', async () => {
    ...
    fetchHttpClientMock.post.mockResolvedValue({ data: { success: true }, error: null });
  ...
  it('should validate token', async () => {
    fetchHttpClientMock.get.mockResolvedValue({ data: { valid: true }, error: null });
  ...
  it('should change password', async () => {
    fetchHttpClientMock.patch.mockResolvedValue({ data: { success: true }, error: null });

    const response = await authGateway.changePassword('currentPassword', 'newPassword');
